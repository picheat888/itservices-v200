...
export const common: Dict = {
    ...
    icon_pick: 'Pick an icon',
    icon_search: 'Search icons…',
    record_missing_title: 'This record is not here',
    record_missing_hint: 'It may have been deleted, or the link is wrong.',
    ...
    import_template_failed: 'Could not download the template',
    ...
    import_preview_truncated: 'Showing {shown} of {total} rows - the counts above cover the whole file.',
