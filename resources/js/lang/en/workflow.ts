...
export const workflow: Dict = {
    ...
    wf_step_by_person: 'People you name',
    wf_step_person_add: 'Add a person',
    wf_step_person_remove: 'Remove',
    wf_step_people_note: 'Any one of them signs — not all of them',
    wf_step_person_required: 'Name at least one person who may approve this step.',
    wf_step_department_empty: 'Nobody works in that department yet - name a person once somebody does, or approve by position.',
    wf_any_of_preview: 'Whichever of them signs first',
