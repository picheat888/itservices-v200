...
export const settings: Dict = {
    ...
    set_sla_desc: 'One first-response target covers every case, always in working hours. Resolution targets come from the rules below, each counting on its own clock.',
