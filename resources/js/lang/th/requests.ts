...
export const requests: Dict = {
    ...
    req_skip_no_manager: 'ข้าม - ผู้ขอยังไม่ได้ตั้งผู้บังคับบัญชา',
    req_skip_no_resource_owner: 'ข้าม - รายการนี้ไม่มีเจ้าของที่อนุมัติได้',
    req_skip_requester_is_owner: 'ข้าม - ผู้ขอเป็นเจ้าของรายการนี้เอง',
