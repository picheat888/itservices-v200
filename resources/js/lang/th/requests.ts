...
export const requests: Dict = {
    ...
    req_attach_section: 'ไฟล์แนบ',
    req_attach_optional: 'แนบใบเสนอราคา ผังพื้นที่ หรือรูปภาพประกอบ (ไม่บังคับ)',
    req_attach_required: 'แนบผังพื้นที่หรือรูปจุดที่ต้องการ - บริการนี้ต้องมีไฟล์แนบจึงจะส่งได้',
    req_attach_types: 'PNG · JPG · PDF · ZIP · Office · ไม่เกิน {size}MB/ไฟล์ · สูงสุด {max} ไฟล์',
    req_attach_needed: 'กรุณาแนบไฟล์อย่างน้อย 1 ไฟล์',
    req_attach_too_large: 'ไฟล์รวมกันใหญ่เกินไป - รวมทุกไฟล์ต้องไม่เกิน {mb}MB',
    req_attach_review: 'แนบไฟล์ {n} ไฟล์',
    ...
    req_block_workflow_incomplete: 'คำขอยังไม่พร้อมใช้งาน กรุณาติดต่อ IT',
