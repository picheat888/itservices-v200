/**
 * The app's password policy, mirrored from the API (EmployeeController::passwordRule() and
 * AuthController@changePassword). Laravel stays the authority — this copy powers the live
 * checklist wherever a password is set: by an admin provisioning an account, or by the
 * person themselves on a forced or voluntary change.
 *
