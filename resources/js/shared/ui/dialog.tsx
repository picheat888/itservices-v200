    ...
    <DialogPortal>
        ...
        <DialogPrimitive.Content
            ...
            className={cn(
                ...
                // [&>*]:min-w-0 lets each grid item shrink below its content's intrinsic width,
                // so w-full fields (and long select labels) stay inside the dialog instead of
                // widening it past max-w-lg.
                'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-lg min-w-0 translate-x-[-50%] translate-y-[-50%] gap-4 border p-6 shadow-lg duration-200 sm:rounded-lg [&>*]:min-w-0',
                className,
            )}
            {...props}
        >
