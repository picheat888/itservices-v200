...
- **เส้น timeline ไม่ทะลุจุดอีก** — จุดของขั้น "กำลังรอ" กับ "ข้าม" เป็นสีโปร่งแสง (`bg-brand/10`, `bg-amber-500/10`) เส้น `before:` จึงมองเห็นผ่านกลางวง แก้ด้วยการห่อจุดด้วยแผ่นทึบ `bg-background` (แนวเดียวกับที่แก้ในตัวแก้ไข Workflow)
