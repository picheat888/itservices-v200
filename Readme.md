...
- เนื้อจดหมายเหมือนใบเสร็จของผู้แจ้ง บวก **`{{ticket.requester}}`** — คนที่กำลังตัดสินใจว่าจะรับเคสไหมต้องรู้ว่าใครแจ้ง
...
- ตารางที่สองเป็น**ของทั้งทีม ไม่ใช่ของตัวเอง** ⇒ ต้องมีคอลัมน์ "อยู่กับใคร" · ตารางแรกมีคอลัมน์ "ใครแจ้ง" แทน
