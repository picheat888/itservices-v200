...
**Guard rails — และต่างจาก Pending ที่ถอนไปเมื่อ 2026-09-13 อย่างไร** ฟีเจอร์ Pending เดิมให้คนถือเคสหยุดนาฬิกาได้เองเป็นจำนวนเท่าไหร่ก็ได้ตามใจ ซึ่งคือช่องให้ยืดเดดไลน์ตัวเองแบบไม่มีขอบเขต รอบนี้ให้อำนาจแบบเดียวกันคืนมา (คนถือเคสเป็นคนกำหนด work class) แต่ปิดช่องนั้นด้วยรั้ว 4 ชั้น:
